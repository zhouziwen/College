...
public class EmojiconGridAdapter extends ArrayAdapter<EaseEmoIcon> {

    private EaseEmoIcon.Type emojiconType;


    public EmojiconGridAdapter(Context context, int textViewResourceId, List<EaseEmoIcon> objects, EaseEmoIcon.Type emojiconType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            if(emojiconType == EaseEmoIcon.Type.BIG_EXPRESSION){
        ...
        EaseEmoIcon emojicon = getItem(position);
