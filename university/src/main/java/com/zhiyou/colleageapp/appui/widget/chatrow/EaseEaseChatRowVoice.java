...
public class EaseEaseChatRowVoice extends EaseEaseChatRowFile {

    private ImageView voiceImageView;
    private TextView voiceLengthView;
    private ImageView readStutausView;

    public EaseEaseChatRowVoice(Context context, EMMessage message, int position, BaseAdapter adapter) {
