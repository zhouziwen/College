...
import com.zhiyou.colleageapp.appui.listener.EaseScrollTabBarItemClickListener;
...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase{
    ...
    private List<EaseEmoIconGroupEntity> emojiconGroupList = new ArrayList<>();
	...
	public void init(List<EaseEmoIconGroupEntity> groupEntities){
     ...
     * @param groupEntity
     */
    public void addEmojiconGroup(EaseEmoIconGroupEntity groupEntity){
        emojiconGroupList.add(groupEntity);
     ...
     */
    public void addEmojiconGroup(List<EaseEmoIconGroupEntity> groupEntitieList){
        for(int i= 0; i < groupEntitieList.size(); i++){
            EaseEmoIconGroupEntity groupEntity = groupEntitieList.get(i);
            emojiconGroupList.add(groupEntity);
