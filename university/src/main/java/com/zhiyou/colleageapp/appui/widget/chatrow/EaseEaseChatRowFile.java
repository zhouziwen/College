...
public class EaseEaseChatRowFile extends EaseChatRow {
    ...
    public EaseEaseChatRowFile(Context context, EMMessage message, int position, BaseAdapter adapter) {
