...
public class EaseEaseChatRowVideo extends EaseEaseChatRowFile {
    ...
    public EaseEaseChatRowVideo(Context context, EMMessage message, int position, BaseAdapter adapter) {
