...
public class EmojiconExampleGroupData {
    ...
    private static final EaseEmoIconGroupEntity DATA = createData();
    
    private static EaseEmoIconGroupEntity createData(){
        EaseEmoIconGroupEntity emojiconGroupEntity = new EaseEmoIconGroupEntity();
        EaseEmoIcon[] datas = new EaseEmoIcon[icons.length];
        for(int i = 0; i < icons.length; i++){
            datas[i] = new EaseEmoIcon(icons[i], null, EaseEmoIcon.Type.BIG_EXPRESSION);
        ...
        emojiconGroupEntity.setType(EaseEmoIcon.Type.BIG_EXPRESSION);
        return emojiconGroupEntity;
    }
    
    
    public static EaseEmoIconGroupEntity getData(){
        return DATA;
    }
}
